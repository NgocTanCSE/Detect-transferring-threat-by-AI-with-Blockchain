        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <section className="rounded-2xl border border-slate-700 bg-slate-900/70 p-4">
            ...
            {txLoading ? (
              ...
              <p className="py-8 text-center text-sm text-slate-500 italic">No recent transactions found for this address.</p>
            )}
          </section>
          ...
          <section className="rounded-2xl border border-slate-700 bg-slate-900/70 p-4">
            ...
            {connLoading ? (
              ...
              <p className="py-8 text-center text-sm text-slate-500 italic">No established connections found for this address.</p>
            )}
          </section>
        </div>
      </div>
