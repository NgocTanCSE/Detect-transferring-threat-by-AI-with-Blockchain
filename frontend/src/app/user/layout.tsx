...
export default function UserLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="fixed left-0 right-0 top-0 z-40 h-16 border-b border-slate-800/50 bg-slate-950/90 backdrop-blur-md">
        <div className="flex h-full items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-slate-100 to-slate-400">
                <Shield className="h-5 w-5 text-black" />
              </div>
              <div>
                <h1 className="text-lg font-semibold text-white">
                  Secure<span className="text-slate-100">Wallet</span>
                </h1>
              </div>
            </div>
          </div>
                ...
                <Link key={item.href} href={item.href}>
                  <Button
                    ...
                    className={`gap-2 ${isActive
                      ? "bg-slate-800 text-white shadow-[0_4px_12px_rgba(0,0,0,0.3)]"
            ...
            {isAuthenticated && user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-slate-100 to-slate-400">
